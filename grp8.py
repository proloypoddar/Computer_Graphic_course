...
def draw_bird(y):
    ...
    for angle in range(360):
        ...
        glVertex2f(100 + bird_w // 2 + (bird_w // 2) * math.cos(rad), 
                   
                   y + bird_h // 2 + (bird_h // 2) * math.sin(rad))
    glEnd()
    ...
    for angle in range(360):
        rad = math.radians(angle)
        glVertex2f(100 + bird_w // 1.5 + (bird_w // 8) * math.cos(rad), 
                   
                   y + bird_h // 1.5 + (bird_h // 8) * math.sin(rad))
    glEnd()
